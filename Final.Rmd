...
ggsave("Presentation-figure/smf1.pdf", f1)
...
t3 <- stargazer(t3_1, t3_2, t3_4,
          ...
          header = FALSE,
          out = "Presentation-figure/smt3.html",
...
t5 <- stargazer(t5_1, t5_3, t5_4, t5_5,
          ...
          out = "Presentation-figure/smt5.html",
          covariate.labels = c("Noncabinet Legacy", "Cabinet Legacy", "Election Wins", "Election Wins ^2", "Share of Droop Quota"),
...
te1 <- stargazer(te1_1, te1_2, te1_3,
                 ...
                 dep.var.labels = "Election Result",
                 out = "Presentation-figure/te1.html")
```
...
te2 <- stargazer(te2_1, te2_2, te2_3,
                 ...
                 dep.var.caption = "Dependent Variable:",
                 dep.var.labels = "Election Result",
                 out = "Presentation-figure/te2.html")
```
